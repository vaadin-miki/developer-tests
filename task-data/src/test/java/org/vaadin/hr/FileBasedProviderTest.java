...
public class FileBasedProviderTest {
    ...
    public void testReadAll() {
        assertEquals("incorrect number of entries read from the file", 500, dataProvider.findAll().size());
    }

    @Test
    public void testFindByFirstName() {
        Collection<Person> entries = dataProvider.search("Russ", null, null, 0);
    ...
    public void testFindNothingByFirstNameAndEuAndAge() {
        Collection<Person> entries = dataProvider.search("Russ", null, true, 50);
        assertTrue("no records should match the search criteria", entries.isEmpty());
    }

    @Test
    public void testFindByFirstNameAndEuAndAge() {
        Collection<Person> entries = dataProvider.search("Russ", null, true, 37);
    ...
    public void testFindBySurnameAndAge() {
        Collection<Person> entries = dataProvider.search(null, "Scott", null, 56);
    ...
    public static final void main(String[] args) {
        JUnitCore.main("FileBasedProviderTest");
    }
